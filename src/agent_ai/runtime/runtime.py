...
Flow:
    PreparedTask
        -> AgentRuntime
             -> Plan Step
                  -> LLM Provider (via AgentOrchestrator)
                  -> LLMResponse
                  -> ToolExecutor
                  -> Observation
                  -> LLM -> ... (sampai step selesai)
        -> DONE / FAILED
...
Prinsip:
    ...
    - Multi-step: menjalankan tiap step plan secara berurutan.
...
class AgentRuntime:
    ...
    Args:
        ...
        max_iterations: batas iterasi per step (anti infinite loop).
    ...
    def _emit_event(self, event_type: str, payload: Dict[str, Any]) -> None:
        ...
        Payload disanitasi (tanpa secret) sebelum dicatat.
        """
    ...
    def _run_single(
        ...
        """Jalankan task tanpa plan (satu langkah tunggal)."""
